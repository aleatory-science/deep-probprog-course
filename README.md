...
| 5 |  Bayesian Regression Models | Read PRML Chapter 3 on Linear Models. <br /> <br /> Ask 3 questions about the chapter. <br /> <br /> Read the Pyro tutorials on Bayesian Regression. <br /> <br /> Solve the weather check exercise in the worksheet. | Pyro Bayesian Regression: [Part I](https://pyro.ai/examples/bayesian_regression.html), [Part II](https://pyro.ai/examples/bayesian_regression_ii.html) <br /> <br />  [Worksheet](week5/DPP_course___Week_5_worksheet.pdf) <br /> <br /> |
