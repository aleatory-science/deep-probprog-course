...
| Computer Science | Magic: The Gathering, Automated Deck Construction. Design a model that finds a good deck automatically based on correlations in existing deck design. Ideas like card substitution models could work as well (e.g., finding cards which replace other cards well). | [Magic: The Gathering - Meta Site](https://mtgmeta.io) |
